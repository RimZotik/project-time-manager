...
Var DeleteInstallerCheckbox
Var DeleteInstallerCheckboxState
...
Function FinishShow
  ...
  IntOp $6 $6 / 96
  IntOp $7 $7 / 96
  System::Call 'user32::CreateWindowEx(i r3, w "${__NSD_CheckBox_CLASS}", w "Удалить установщик после установки", i ${__NSD_CheckBox_STYLE}, i r4, i r5, i r6, i r7, p r1, i0, i0, i0) i .s'
  Pop $DeleteInstallerCheckbox
  SendMessage $HWNDPARENT ${WM_GETFONT} 0 0 $1
  SendMessage $DeleteInstallerCheckbox ${WM_SETFONT} $1 1
  SendMessage $DeleteInstallerCheckbox ${BM_SETCHECK} ${BST_CHECKED} 0
